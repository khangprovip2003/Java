...
public class CraftsmanV2 {
    ...
    public static void playWidthChildClass(){
      Square s1 = new Square ("TÍA","PINK",6.0);
      s1.paint(); // không muốn núp bóng BA, muốn có bản sắc , tui là HV ( dĩ nhiên là HCN )
                                                               //Square kìa , mày thể hiện không phải là BA
        // vi diệu 1
