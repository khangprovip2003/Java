...
public class Cat extends Pet {
    ...
    public double run() {
        ...
        // ngẫu nhiên , như vậy chúng thuộc Nhóm/Khuôn ngẫu nhiên , class ngẫu nhiên xuất hiện
        // JDK có sẵn Khuôn này rồi , tên là Random
        //                                              ~~~Scanner ~~ Math
        Random mayNgauNhien = new Random();
      //     Random mayNgauNhien = new Random().nextDouble() * MAX_SPEED; // dùng xong bị giết luôn
